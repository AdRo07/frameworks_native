...
public:
    ...
    virtual void setIsCursorLayerHint(bool isCursor) {
        // Cursor layer is introduced in HWC version 1.4
    }
            ...
            if (disp.list) {
                ...
                if ( hwcApiVersion(mHwc) == 0)
                {
                    ...
                    for (size_t i=0 ; i<list->numHwLayers ; i++) {
                        ...
                        const hwc_layer_1_t&l_1 = disp.list->hwLayers[i];
                        ...
                        result.appendFormat(
                                ...
                                l_1.sourceCrop.left, l_1.sourceCrop.top, l_1.sourceCrop.right, l_1.sourceCrop.bottom,
